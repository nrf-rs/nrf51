#[doc = "Reader of register ECB"]
pub type R = crate::R<u32, super::ECB>;
#[doc = "Writer for register ECB"]
pub type W = crate::W<u32, super::ECB>;
#[doc = "Register ECB `reset()`'s with value 0"]
impl crate::ResetValue for super::ECB {
    type Type = u32;
    #[inline(always)]
