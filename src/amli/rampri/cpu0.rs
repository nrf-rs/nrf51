#[doc = "Reader of register CPU0"]
pub type R = crate::R<u32, super::CPU0>;
#[doc = "Writer for register CPU0"]
pub type W = crate::W<u32, super::CPU0>;
#[doc = "Register CPU0 `reset()`'s with value 0"]
impl crate::ResetValue for super::CPU0 {
    type Type = u32;
    #[inline(always)]
